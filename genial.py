...
def setup():  # Sets up the pins of the GPIO
    ...
    red_led = PWMLED(23)  # Declaring the LEDs as PWMLED allows the use of the module .pulse()
    blue_led = PWMLED(25)
    green_led = PWMLED(17)
...
def colours_numbers():  # Generates a random sequence of numbers from 1 to 4 (1 = red, 2 = blue, 3 = green, 4 = yellow)
    randnum = randint(1, 4)
...
def check_sequence():  # Checks whether the player turned the right LEDs on or not
    ...
    if player == lights:  # All the LEDs pulse when the player's sequence is right
        ...
        red_led.pulse()  # Only the red LED pulse when the player's sequence is wrong
